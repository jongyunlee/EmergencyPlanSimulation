...
//float intensity(vec4 p1, vec4 p2, vec4 p3, vec4 lightPosition) {
...
void ProduceVertex(float s, float t) {
     ...
     // perVertexColor = vec3(0.0, 0.0, 0.4) + intensity(gl_in[0].gl_Position, gl_in[1].gl_Position, gl_in[2].gl_Position, gl_LightSource[0].position) * vec3(0, 0, 1);
     intensity(gl_in[0].gl_Position, gl_in[1].gl_Position, gl_in[2].gl_Position);
